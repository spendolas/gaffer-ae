...
echo ""
echo "NOTE: This builds for the current platform only."
echo "For Windows: run this script on a Windows machine, or manually:"
echo "  1. Download node-$NODE_VERSION-win-x64.zip from nodejs.org"
echo "  2. Extract node.exe, copy to dist/"
echo "  3. Run: npx postject node.exe NODE_SEA_BLOB dist/sea-prep.blob --sentinel-fuse NODE_SEA_FUSE_fce680ab2cc467b6e072b8b5df1996b2"
echo "  4. Rename to gaffer-daemon.exe"
